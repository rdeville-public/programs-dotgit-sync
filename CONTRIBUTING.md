...
[bug_tracker_opened_issues]: https://framagit.org/rdeville-public/programs/dotgit-sync/issues/?sort=created_date&state=opened&or[label_name][]=Type%3A%3ABug&or[label_name][]=Type%3A%3ARegression&first_page_size=200
...
DotGit Sync, **including completely new features and minor improvements to
...
[issues_page]: https://framagit.org/rdeville-public/programs/dotgit-sync/-/issues
...
- You may want to **include screenshots or screen recordings** which help you
  ...
  instance).
- **Explain why this enhancement would be useful** to most DotGit Sync users. You
...
[new_issues_page]: https://framagit.org/rdeville-public/programs/dotgit-sync/-/issues/new
...
```text
[DotGit Sync] - Join The Project Team
```
...
[README]: https://framagit.org/rdeville-public/programs/dotgit-sync/-/blob/main/README.md
[CODE_OF_CONDUCT]: https://framagit.org/rdeville-public/programs/dotgit-sync/-/blob/main/CODE_OF_CONDUCT.md
